...
// Per-crew wait: a pickup / dropoff carrying more than one crew waits at every
// crew stop for them to board / alight. Total extra minutes = crewCount *
// buffer (all stops, once there's >1 crew) - folded into the ride's
// duration_min so ETA, end_at and the Pickup-Time auto-suggest all account for
// it. Per-city override on cities.crew_wait_buffer_min.
